...
namespace 程式期末專案 {
    ...
    public partial class Database3DataSet : global::System.Data.DataSet {
        ...
        public partial class staffDataTable : global::System.Data.TypedTableBase<staffRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public staffRow AddstaffRow(int Id, string date, string name, string file, string text, string level, string status) {
        ...
        public partial class staffRow : global::System.Data.DataRow {
            ...
            public string file {
                get {
                    return ((string)(this[this.tablestaff.fileColumn]));
                }
                set {
                    this[this.tablestaff.fileColumn] = value;
                }
            }
...
namespace 程式期末專案.Database3DataSetTableAdapters {
    ...
    public partial class staffTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[staff] WHERE (([Id] = @Original_Id) AND ([date] = @Original_da" +
                "te) AND ([name] = @Original_name) AND ([file] = @Original_file) AND ([text] = @O" +
                "riginal_text) AND ([level] = @Original_level) AND ([status] = @Original_status))" +
                "";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[staff] ([Id], [date], [name], [file], [text], [level], [status" +
                "]) VALUES (@Id, @date, @name, @file, @text, @level, @status);\r\nSELECT Id, date, " +
                "name, [file], text, level, status FROM staff WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[staff] SET [Id] = @Id, [date] = @date, [name] = @name, [file] = @file, [text] = @text, [level] = @level, [status] = @status WHERE (([Id] = @Original_Id) AND ([date] = @Original_date) AND ([name] = @Original_name) AND ([file] = @Original_file) AND ([text] = @Original_text) AND ([level] = @Original_level) AND ([status] = @Original_status));
SELECT Id, date, name, [file], text, level, status FROM staff WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, date, name, [file], text, [level], status FROM dbo.staff";
        ...
        public virtual int Fill(Database3DataSet.staffDataTable dataTable) {
        ...
        public virtual Database3DataSet.staffDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database3DataSet.staffDataTable dataTable = new Database3DataSet.staffDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database3DataSet.staffDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_date, string Original_name, string Original_file, string Original_text, string Original_level, string Original_status) {
            ...
            if ((Original_file == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_file));
            }
        ...
        public virtual int Insert(int Id, string date, string name, string file, string text, string level, string status) {
            ...
            if ((file == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[3].Value = ((string)(file));
            }
            if ((text == null)) {
        ...
        public virtual int Update(int Id, string date, string name, string file, string text, string level, string status, int Original_Id, string Original_date, string Original_name, string Original_file, string Original_text, string Original_level, string Original_status) {
            ...
            if ((file == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(file));
            }
            if ((text == null)) {
                throw new global::System.ArgumentNullException("text");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string date, string name, string file, string text, string level, string status, int Original_Id, string Original_date, string Original_name, string Original_file, string Original_text, string Original_level, string Original_status) {
            return this.Update(Original_Id, date, name, file, text, level, status, Original_Id, Original_date, Original_name, Original_file, Original_text, Original_level, Original_status);
        }
    }
